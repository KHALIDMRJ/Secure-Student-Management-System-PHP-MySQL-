...
/**
 * Render a honeypot hidden field. Bots fill any visible-looking input;
 * humans leave it empty. Hidden via Bootstrap's d-none class so it never
 * paints on screen, but is still in the DOM (unlike type="hidden" which
 * many bots correctly skip).
 *
 * @return string HTML markup for the honeypot field.
 */
...
/**
 * True if the honeypot field was filled in (bot detected).
 *
 * @return bool
 */
