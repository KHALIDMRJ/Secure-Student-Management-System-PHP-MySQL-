...
/* =========================================================
   ...
   - Ctrl/Cmd+Enter executes the form
   - Clear / Copy / Example-fill buttons
   - Client-side CSV export of result table
...
(function () {
    ...
    /* ----- Keyboard shortcuts -----
       Tab inserts 4 spaces; Ctrl/Cmd+Enter submits the form. */
    ...
    /* ----- Example chips: paste into editor & focus ----- */
    exampleBtns.forEach(function (btn) {
        btn.addEventListener('click', function () {
            editor.value = btn.dataset.sql || '';
            editor.focus();
            refresh();
            // Scroll editor into view in case the chip was below it.
        ...
        exportBtn.addEventListener('click', function () {
            ...
            rows.forEach(function (row) {
                ...
                cells.forEach(function (cell) {
                    // textContent collapses NULL pill back to "NULL" — fine.
